                ...
                <a href="/channel/{cid}">
                    <div class="card profile-card text-white bg-primary mb-2">
                        ...
                        <div class="img-container text-center"
                            ...
                            <img src="https://cdn.jsdelivr.net/gh/cyberdevlk/imagecloud@main/cloudv2/loading.gif" class="card-img-top lzy_img"
    ...
    <div class="col">
        ...
        <div class="card profile-card text-white bg-primary mb-2">
            <a href="" onclick="openEditPopupForm(event, '{img}', '{ctype}', '{cid}', '{title}')"
                ...
                <div class="img-container text-center"
                    style="width: 145px; height: 145px; display: inline-block; overflow: hidden; position: relative; border-radius: 50%; margin: auto;">
                    <img src="https://cdn.jsdelivr.net/gh/cyberdevlk/imagecloud@main/cloudv2/loading.gif"
    ...
    <div class="col">
        ...
        <div class="card text-white bg-primary mb-2">
            <a href=""
                ...
                <img src="https://cdn.jsdelivr.net/gh/cyberdevlk/imagecloud@main/cloudv2/loading.gif" data-src="{img}"

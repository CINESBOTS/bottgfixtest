    ...
    phtml = """
            <div class="col">
                    ...
                    <div class="card text-white bg-primary mb-3">
                        ...
                        <img src="https://cdn.jsdelivr.net/gh/cyberdevlk/imagecloud@main/cloudv2/loading.gif" class="lzy_img card-img-top rounded-top"
...
async def posts_tmdb(posts):
    phtml = """
            ...
            <a href="/tmdb/{type}/{id}">
                <div class="card-head">
                    <img src="https://cdn.jsdelivr.net/gh/cyberdevlk/imagecloud@main/cloudv2/loading.gif" class="card-img lzy_img" data-src="{img}" alt="{title}">

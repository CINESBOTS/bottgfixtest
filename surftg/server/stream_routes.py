...
async def wstream_handler_watch(request: web.Request):
    ...
    try:
        ...
        chat_id = f"-100{chat_id}"
        return web.Response(text=await render_page(msg_id, hash_value, chat_id=chat_id, route="static", file_name=name, file_size=size, db_id=db_id), content_type='text/html')
